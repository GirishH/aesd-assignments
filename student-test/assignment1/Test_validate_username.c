...
void test_validate_my_username()
{
    ...
    char* malloc_username;
    myusrname = my_username();
    malloc_username = malloc_username_from_conf_file();
    TEST_ASSERT_EQUAL_STRING_MESSAGE(myusrname, malloc_username, "Test:Usernames are identical");
}
